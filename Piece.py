...
class Queen(Rook, Bishop):
    def get_valid_peaceful_moves(self, game_state):
        _moves = []
        _moves = Rook.get_valid_peaceful_moves(self, game_state)
        _moves = _moves + Bishop.get_valid_peaceful_moves(self, game_state)
        return _moves

    def get_valid_piece_takes(self, game_state):
        _moves = []
        _moves = Rook.get_valid_piece_takes(self, game_state)
        _moves = _moves + Bishop.get_valid_piece_takes(self, game_state)
        return _moves
